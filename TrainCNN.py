...
def main():
    ...
    ###############First Convolution#################
    filter_height_conv1 = 3
    filter_width_conv1 = 3
...
###########################################################################################################
    ...
    nrOfInputNeurons = 8000  # 27040
    nrOfOutputPixels = 13*13*number_of_filters*number_of_filters_conv2   # 13pixel * 13pixel * 10filter * 5 filter = 8450
