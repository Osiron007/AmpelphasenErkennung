...
def main():
    ...
    filter_conv1 = tf.Variable(tf.truncated_normal([filter_height_conv1,filter_width_conv1,number_of_in_channels_conv1,number_of_out_channels_conv1], stddev=0.1))
...
###########################################################################################################
    ...
    filter_conv2 = tf.Variable(
        tf.truncated_normal([filter_height_conv2, filter_width_conv2, number_of_in_channels_conv2, number_of_out_channels_conv2],
                            stddev=0.1))
